...
Append non-trivial structural, methodological, and scope decisions here.

## 2026-06-07

- **Create as OVMG-family subproject.** The workbench lives under `Grammaticality_de_idealized/subprojects/evolutionary-dag-workbench/` because it should piggyback on the grammaticality ecology without inheriting any single existing model as a commitment.
