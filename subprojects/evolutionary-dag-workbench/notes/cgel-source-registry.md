...
| `cgel-negation-polarity` | `<CGEL_ROOT>/out/095_2 Verbal negation.pdf`; `<CGEL_ROOT>/out/097_4 Polarity-sensitive items.pdf` | Negation, NPI licensing, negative concord contrast cells |
