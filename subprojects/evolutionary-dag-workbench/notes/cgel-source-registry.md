...
| `reynolds-personhood-proforms` | `<PAPERS_ROOT>/Personhood_and_proforms/personhood+pro-forms.docx`; `<PAPERS_ROOT>/Personhood_and_proforms/archive/main-old.tex`; reviewer notes in `<PAPERS_ROOT>/Personhood_and_proforms/reviews/` | Personhood/pro-form category pressure, reference-chain coherence, dialect/social-identity caveats; not yet a policy/audience task dataset |
| `reynolds-transparent-free-relatives` | `<PAPERS_ROOT>/Transparent_free_relatives/`; especially `two-kinds.tex`, `coca-data/`, and `DECISIONS.md` | Transparent free relatives, COCA-backed verb-class asymmetry, opportunity/absence discipline, category-flexibility thresholds |
| `reynolds-linguistic-transparency-coca-pilot` | `<PAPERS_ROOT>/Linguistic_transparency/paper/data/coca-pilot.md`; `<PAPERS_ROOT>/Linguistic_transparency/paper/data/kwic-checks.md`; `<PAPERS_ROOT>/Linguistic_transparency/paper/sections/02-morphosyntactic-transparency.tex` | COCA/KWIC method precedent for number-transparent QN agreement, partitive/non-partitive complement profiles, boundary `bunch`, and projectibility-profile framing |
| `reynolds-english-lbc-opportunity-funnel` | `<PAPERS_ROOT>/English_LBC_functionalist/submission/cllt/cllt_anonymous_manuscript.tex`; analysis scripts and validation data in `<PAPERS_ROOT>/English_LBC_functionalist/` | Opportunity-denominator funnel, manual validation, search-error audit, posterior upper bounds, and detection-power framing for informative absence |
| `reynolds-independent-relative-whose` | `<PAPERS_ROOT>/Independent_relative_whose/`; `<PAPERS_ROOT>/Independent_relative_whose_A_Bayesian_analysis_of_a_low-frequency_gap/` | Rare relative constructions, independent relative `whose`, low-opportunity Bayesian framing, judgment-item materials |
