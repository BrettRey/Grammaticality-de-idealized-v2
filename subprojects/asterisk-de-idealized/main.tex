...
Every competent speaker of English can tell that \ungram{\mention{Can the have running}} is impossible. What is that impossibility a judgement of: structure, value, repertoire, or discomfort? The asterisk answers as if these were one. The cluster in (\ref{ex:cluster}) suggests otherwise.
