...
Section~\ref{sec:distinction} introduces the constitutive-etiological distinction and the formal framework. Section~\ref{sec:preemption} develops Module~1 (preemption). Section~\ref{sec:coordination} develops Module~2 (coordination equilibria). Section~\ref{sec:integration} integrates the two modules and derives stability profiles. Section~\ref{sec:predictions} states empirical predictions and disconfirmation conditions. Section~\ref{sec:conclusion} concludes.
