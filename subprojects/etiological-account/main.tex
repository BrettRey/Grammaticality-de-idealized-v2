...
What explains these differences? Knowing what grammaticality \emph{is}~-- what makes a form grammatical or not~-- doesn't automatically answer this question. Even if we grant that grammaticality depends partly on whether a form is in the community's repertoire, we still need to explain \emph{why} some forms get excluded from that repertoire and stay excluded, while others drift in or out over time.
