...
\begin{itemize}
  ...
  \item \textbf{Iterated learning.} The poverty of the stimulus acts as a transmission bottleneck that drives regularization \citep{kirby2014}. Preemption is the mechanism that enforces this compression: by treating absence as evidence of exclusion, learners filter out noise and amplify partial regularities into categorical constraints.
\end{itemize}
