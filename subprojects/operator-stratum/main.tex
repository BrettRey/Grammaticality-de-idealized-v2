...
A second illustration comes from Japanese sentence-final particles. In many registers, the particle \mention{ka} conventionally marks interrogative force, while declaratives are unmarked or carry other particles; intonation interacts with these choices, and colloquial speech permits additional variation \citep[e.g.,][]{kuno1973,shibatani1990}. The particle doesn't contribute conceptual content so much as it configures what kind of move the utterance counts as and what responses are licensed. In contexts where \mention{ka} is the expected interrogative exponent and intonation doesn't independently supply an interrogative reading, omitting it yields a different illocutionary construal rather than a merely stylistic variant: the addressee's uptake obligations shift. This is the sense in which clause-typing is an operator: a small, conventionalised contrast with categorical consequences for public coordination.
