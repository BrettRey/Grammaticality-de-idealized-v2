...
A familiar temptation is to reduce this to a contrast between \enquote{structure} and \enquote{use}: morphosyntax counts as grammar; accent and lexical choice don't.\footnote{This is the moment at which introductory diagrams draw a reassuring boundary; languages then spend the rest of the semester crossing it.} But this gloss is neither typologically adequate nor explanatory. Many languages grammaticalize prosody, phonation, or tone as obligatorily as agreement or tense \citep{hyman2011,ladd2008}. Many grammatical categories aren't universal: a language may lack tense \citep{comrie1985} or number \citep{corbett2000} while sustaining robust categorical judgments elsewhere. And some lexical items function as operators with constraints indistinguishable from inflectional morphology \citep{hoppertraugott2003,bybee2010}.
...
These conditions characterize the core of the operator stratum; actual form--value relations approximate them to varying degrees.
