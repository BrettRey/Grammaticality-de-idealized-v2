...
Neuroimaging work supports this integration of form and meaning. Fedorenko and colleagues find that brain regions activated by syntactic manipulations overlap substantially with those activated by semantic ones \autocite{Fedorenko2011, Fedorenko2012, Fedorenko2024}, suggesting a shared neural substrate rather than separate processing modules.
...
The feeling of ungrammaticality can be conceptualized as a negative response triggered by the detection of unstable or missing form--value relations. This response wouldn't define grammaticality itself but would instead serve as a speaker's heuristic detection mechanism. This distinction helps explain:
