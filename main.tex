...
At its foundation, grammaticality depends on stable pairings between morphosyntactic forms and their values within specific language communities. By \term{value} I mean primarily meaning: what interpretations a form makes available in context. This is a core insight of Construction Grammar~-- that form--meaning pairings exist at all levels of grammatical organization, from morphemes to abstract syntactic patterns \autocite{goldberg1995constructions}.
