...
Grammaticality emerges from regularities that hold within a particular language community, dialect, register, or situation, or what \textcite[3]{wiese2023} calls a \enquote{communicative-situation}.
...
\textbf{Prediction:} If participants are led to treat presented tokens (like LBE) as intentional dialectal/ingroup resources (lowering $e_t$ and raising perceived counterfactual utility), then satiation (or at least reduced feeling of ungrammaticality) should be more likely than in standard paradigms where high effective preemption $p_t$ dominates.
...
\begin{enumerate}
   \item \textbf{*Can the have running} (Nonsense): 
