...
The release test suite contains 316 checks: 27 legacy provenance fixtures, 46
occasion-simulation smoke checks, 57 revised-engine checks, 18 conditional
observation-shell checks, and 168 closed-loop checks. A clean regeneration of
...
The final result is adverse to an earlier, stronger dispersion-leading claim
and is retained as such. The programmed repair comparison is only a wiring
check; it supplies no maintenance or control warrant. Exact parameters, seeds,
